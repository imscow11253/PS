...
### 출력 
 ...
 <p>10090 counting inversion 문제랑 같은 형식이다. AlKon 중급 세미나 분할정복 때 배웠고 이런 문제가 counting inversion 문제와 같은 형식이라는 것을 깨달았다. 같다는 것을 알아낼 수 있도록 문제의 핵심을 파악하는 능력을 길러야겠다. </p>
