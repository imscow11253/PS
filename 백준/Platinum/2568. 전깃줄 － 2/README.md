...
### 풀이 
 ...
 <p>최근에 LIS 문제를 풀었어서 그런지 LIS 문제임이 바로 보였다. A 건물의 번호 기준으로 B 건물 번호를 정렬하고, 거기서 LIS를 구한 다음에 LIS에 해당하지 않는 번호를 오름차순으로 출력하면 된다. 비교적 간단한 문제였다.</p>
