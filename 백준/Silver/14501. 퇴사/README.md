...
### 풀이 
 ...
 <p>간단한 dp 문제인줄 알았는데 살짝 발상의 전환이 필요한 dp였다. 보통 dp를 업데이트하는 방식은 점화식을 세운다. 이 점화식도 bottom to top 방식으로 세우는데, 이 문제에서는 그게 도저히 논리적으로 안될 것 같았다. 결국 모르겠어서 GPT의 도움을 조금 받았다. 신기하게도 점화식을 top to bottom 방식으로 세워서 푸는 것이었다. 신기했다.</p>
