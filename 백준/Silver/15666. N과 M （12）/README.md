...
### 풀이 
 ...
 <p>처음에 잘 짰는데 원인 모를 segmentation fault가 계속 발생했다. 그래서 GPT한테 물어보니 재귀 함수에서 종료 조건을 명시하지 않아서라고 했다. vec 변수의 크기가 m을 넘는 경우에 return 해줘야 한다고 해서 추가했더니 해결되었다. </p>
