...
### 출력 
 ...
 <p>처음 집중 안될 때 봤을 때는 '아 이거 예외케이스 많아서 귀찮을 것 같은데..' 싶어서 미루었던 문제인데 집중 잘 될때 다시 보니까 너무 쉬웠다. 문제를 잘 읽으면 된다. 자신보다 덩치가 큰 사람의 수 +1이 자신의 등수이다. 그래서 그냥 이중 반복문 써서 각 사람 별로 자신보다 덩치 큰 사람 개수 세면 된다. 시간 복잡도는 O(n^2)에 해결된다. </p>
