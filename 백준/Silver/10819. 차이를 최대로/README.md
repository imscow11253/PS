...
### 출력 
 ...
 <p>처음엔 규칙을 찾아야 하는 문제인가 고민했었는데 잘 보면 n의 범위가 굉장히 작음을 알 수 있다. 그래서 브루트포스로 풀려고 보니 순열 문제라 브루트포스는 쉽지 않을 것 같았다. 그래서 백트래킹을 사용해서 풀었다. 백트래킹을 사용하면 쉽게 풀리는 문제였다. </p>
