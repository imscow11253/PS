...
### 풀이 
 ...
 <p>BFS에 빡 구현 문제인데 예외 케이스를 잘 생각해야 한다. 소문자, 대문자, $가 가장자리에 있는 경우도 진입점이 될 수 있다. 처음에 2번 정도 틀렸는데, 테스트 케이스마다 초기화를 안해주는 set이 있어서 틀렸다. 시간 제한은 null null 하다.</p>
