...
### 출력 
 ...
 <p>보자마자 비트마스킹을 이용한 dp 문제임을 알았다. 노드의 상태를 통해서 dp를 memoization 하는 비트마스킹 dp의 전형적인 유형이었다. 몇 번 풀어보았는데 확실하게 풀줄 아는 유형이 아닌 것 같아서 다시 풀어보았다. 3차원 dp를 사용해서 풀었다. </p>
