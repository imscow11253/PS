...
### 출력 
 ...
 <p>단순 브루트포스 문제인데 반례를 잘 생각해야 한다. 모두가 당연하게 생각하듯이 각 점을 꼭짓점으로 4 사분면에 별이 들어가는 최대 개수를 반환하면 될 것 같지만 반례가 존재한다. 다음 그림과 같은 경우가 반례이다. 그래서 각 별의 x점, y점 모두의 조합에 대해서 4 사분면을 확인해야 한다. </p>

<img width="302" height="227" alt="image" src="https://github.com/user-attachments/assets/f272071e-d52d-489d-aa43-86b92ece2a46" />
