...
### 출력 
 ...
 <p>2-2 알고리즘 수업에서 들었던 그리디에서 deadline 스케줄링 문제이다. 처음엔 테이프 문제인줄 알고 그렇게 풀었는데 틀렸다. 테이프 문제는 손해가 주어지는 느낌이고, 마감기한은 deadline처럼 풀어야 한다. 구현해본 적은 없어서 구현법이 틀렸다. GPT 채찍질해서 풀었다. </p>
