...
### 풀이 
 ...
 <p>문제를 잘 파악하면 무슨 문제인지 보인다. 근데 난 못찾았다. 결국 검색을 했고, 이 문제의 유형이 LIS임을 알았다. LIS는 되게 간단한 코드만 쓰면 되어서 한 때 내가 즐겨 풀었던 문제이다. 근데 코드가 기억이 잘 안나서 내가 예전에 썼던 코드를 다시 꺼내 보았다. 이거 외워두고 풀면 좋다. </p>
