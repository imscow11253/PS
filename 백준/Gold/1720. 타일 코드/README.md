...
### 풀이 
 ...
 <p>기말 끝나고 한 문제도 안 풀다가 업보청산의 시간..

DP를 떠올리는 것을 쉬우나 좌우 대칭을 제거하는게 조금 생각해야 한다. dp[n] = dp[n-1] + (dp[n-2] *2) 점화식은 다음과 같고 좌우 대칭 경우를 제거하는 식은 n이 짝/홀에 따라 다르다.</p>
