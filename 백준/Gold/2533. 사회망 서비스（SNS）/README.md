...
### 출력 
 ...
 <p>규칙을 찾아서 재귀를 사용해서 풀었다. 이것도 나한테 알고리즘 분류하라고 하면 분할정복일 것 같은데 트리에서 분할정복을 적용하면 dp라고 한다. 1135 문제랑 같은 개념이다. 이거에 대한 설명은 다음 링크에 있다. https://www.acmicpc.net/board/view/162438 </p>

 <p>그래서 난 특정 노드에서 서브 트리에 대해서 재귀를 돌리고 각 서브 트리에 대해서 하나라도 얼리어답터가 아니면 현재 노드가 얼리어답터가 되도록 반환했다. </p>
