...
### 출력 
 ...
 <p>그냥 BFS로 풀면 된다. 어려울 것 없다. 근데 난 바보 같이 if문 col의 범위를 테스트할 때 m 으로 해야하는데 n으로 해서 계속 영문도 모르고 틀렸다. 결국 차근차근 디버깅해서 찾았다. 틀렸을 땐 질문 게시판에서 반례를 뒤적이지 말고 직접 디버깅해보는, 테스트 케이스 찾아보는 시도를 하면서 실력을 기르자</p>
