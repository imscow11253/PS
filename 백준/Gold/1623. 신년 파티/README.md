...
### 풀이 
 ...
 <p>dp를 사용했다. 근데 난 못 풀고 결국 풀이를 살펴봤다. 재귀 구조가 바로 보인다. 이 과정에서 memoization을 통해서 dp를 사용할 수 있다. 그리고 dp에서 이제 trace 하는 과정은 항상 비슷한 느낌을 가지면 된다. dp를 가지고 추적하는 로직을 작성해주면 된다. 이 코드 잘 보도록 하자. </p>
