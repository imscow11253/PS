...
### 풀이 
 ...
 <p>교내 동아리 알고리즘 세미나에서 오늘 ‘세그먼트 트리’ 를 배웠다. 세그먼트 트리는 개념 자체가 쉬운 개념이 아니라서 기본 문제만 해도 골드 1이라고 한다. 처음 풀어봤는데 구현이 마냥 쉽지는 않았다. 그냥 세그먼트 트리를 사용하는 전형적인 기본 문제였다. </p>
