...
### 출력 
 ...
 <p>기대안하고 긴가민가 하면서 떠오른 아이디어를 바로 구현해서 틀릴 생각으로 제출했는데 통과했다... 운이 좋았던 것 같다. MST 구하는 prim 알고리즘에서 최소신장트리가 아니라 최대신장트리가 되도록 푼 다음 목적 노드 2개 간의 경로에서 간선 크기가 최소인 것을 출력하니 되었다. 그냥 prim 알고리즘 문제였다. </p>
