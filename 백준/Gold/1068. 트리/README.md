...
### 풀이 
 ...
 <p>어려울 것 없는 dfs이지만 한 가지 간과한 부분이 있어서 한 번 틀렸다. cut 되고 나면 cut 시킨 노드의 부모가 자식을 cut된 노드만 가지고 있었을 시, 그 부모 노드가 새로운 leaf 노드가 될 수 있다. 이것 빼고 나면 그냥 단순 dfs이다. </p>
