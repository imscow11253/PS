...
### 풀이 
 ...
 <p>단순 bfs 문제 인줄 알았는데 벽을 부수었을 때 visit 처리를 해주어야 해서 3차원 배열을 썼다. 처음엔 부술 때마다 z 축을 +1 해서 메모리 초과가 났는데 사실상 2층만 있었으면 되었다…ㅋㅎ </p>
