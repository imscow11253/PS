...
### 풀이 
 ...
 <p>예전에 틀렸던 문제를 다시 풀어보았다. 배낭 문제랑 비슷하다고 생각해서 dp[앱][바이트]로 두고 풀었는데 잘 안되었다. 약간 생각을 달리 해서 dp[앱][비용]으로 풀었더니 되었다. 

나중에 꼭 다시 풀어보도록 하자. DP는 항상 어렵다.</p>
