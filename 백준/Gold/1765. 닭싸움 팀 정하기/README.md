...
### 출력 
 ...
 <p>그렇게 어렵지 않았다. 친구인 경우는 같은 그룹으로 두어야 하니까 union-find를 사용했고, 원수인 경우는 그래프로 두었다. 그리고 edge가 이어질 때마다 grap[i]의 내부 노드들은 원수의 원수이므로 서로 union을 해주었다. </p>
