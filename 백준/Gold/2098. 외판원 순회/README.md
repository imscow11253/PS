...
### 출력 
 ...
 <p>외판원 문제는 standard 문제다. 그래서 풀이를 봤다. DFS, DP, 비트마스킹을 섞어서 계산해야하는 악랼한 문제다.. 심지어 DP에서 2차원 배열을 사용하는데, column을 비트마스킹으로 센다.. 완전 멘붕.. 코드를 이해하는데도 오래 걸렸다. 이거 유형을 좀 익혀놓는게 좋을 것 같다. 외판원순회문제, 해밀턴 경로 찾기 문제 </p>
