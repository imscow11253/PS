...
### 풀이 
 ...
 <p>삼성 알고리즘 특강이랑 코테 준비하면서 구현 문제랑 그래프 문제를 많이 풀었어서 그런지 그렇게 어렵지 않았다. 그냥 다이스트라를 각 node 기준으로 돌려서 최단 거리를 계산해서 비교해서 구했다. </p>
