...
### 출력 
 ...
 <p>개념을 3개나 써서 풀었다. 근데 그렇게 어렵진 않았다. 우선 에라토스테네스의 체를 써서 소수를 다 구했다. 그런다음 소수들의 누적합을 구했다. 그런다음 투포인터로 누적합을 탐색하며 n과 동일한 구간이 있는지를 판별했다. </p>
