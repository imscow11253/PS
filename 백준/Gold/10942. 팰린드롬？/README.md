...
### 출력 
 ...
 <p>문제만 읽었을 땐 어떻게 풀어야할지 막막했다. dp 냄새가 솔솔 났다. 종이에 적으면서 하니까 재귀가 바로 보였고, 재귀를 하면서 dp의 메모이제이션을 써야함을 깨달았다. 그 다음은 구현해서 쓱쓱 풀었다. </p>
