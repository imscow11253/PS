...
### 출력 
 ...
 <p>dp인줄 알았는데 아니었다. 블로그 글 보고 깨달았다. 그리디로 푸는 건데 이건 그리디라는 것을 알아도 풀기 굉장히 어려웠다. 앞에서부터 차례로 가되, 각 칸에 영향을 줄 수 있는 칸의 경우의 수를 없애가면서 그리디하게 풀 수 있는 문제이다. </p>
