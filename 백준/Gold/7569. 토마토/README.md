...
### 풀이
 ...
 <p>그냥 저번에 풀었던 골드 5 토마토 문제랑 풀이는 같다. 다만 3차원 배열이라서 분기처리를 좀 추가해줘야하는 점이 다르다. 3차원 배열을 오랜만에 사용해봐서 조금 헤매다가 차근차근 생각해서 풀어냈다. 알고리즘 적으로 어려운건 없었다. </p>
