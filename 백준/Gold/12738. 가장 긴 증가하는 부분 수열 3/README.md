...
### 출력 
 ...
 <p>12015 문제와 같은 풀이로 풀 수 있다. 근데 구현하려니 내가 그동안 LIS를 잘못 이해하고 있었던 것 같다. vec에 새로운 걸 삽입할 때, compaction이나 공간을 만들 필요 없이 그냥 덮어 씌우면 된다. 이거 이해 잘 해보자.</p>
